...
st.markdown("A game app where we need to determine *customer's satisfaction* by testing out the customer's **retention "
            "rate** after 1 and 7 days in two different versions of the game app having different setting in a "
            "particular game app feature and determine which feature version performs better in retaining customers.")
...
st.markdown("")
data = pd.read_csv(r"C:\Users\maria\OneDrive\Desktop\DataSets\AB Testing Mobile App - Cookie Cats.csv")
st.write(data)
...
st.markdown("***EXPERIMENTAL GROUP:*** **Gate 40** because this is the group that experiences the change we're testing.")
